    ...
    <footer class="bg-slate-950 text-slate-400 py-16 border-t border-slate-900">
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-1 md:col-span-1">
                    <div class="flex items-center gap-2 mb-6">
                        <div class="w-8 h-8 bg-amber-600 text-white flex items-center justify-center font-bold text-lg rounded-sm">P</div>
                    ...
                    <div class="flex gap-4">
                        <div class="w-8 h-8 bg-slate-900 rounded flex items-center justify-center hover:bg-amber-600 hover:text-white transition-colors cursor-pointer"><i data-lucide="facebook" class="w-4 h-4"></i></div>
                        <div class="w-8 h-8 bg-slate-900 rounded flex items-center justify-center hover:bg-amber-600 hover:text-white transition-colors cursor-pointer"><i data-lucide="instagram" class="w-4 h-4"></i></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        <li class="flex justify-between border-b border-slate-900 pb-2"><span>Mon - Fri:</span> <span class="text-white">9:00 AM - 6:00 PM</span></li>
                        <li class="flex justify-between border-b border-slate-900 pb-2"><span>Saturday:</span> <span class="text-white">9:00 AM - 3:00 PM</span></li>
            ...
            <div class="border-t border-slate-900 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-600">
                ...
                <p class="mt-2 md:mt-0 flex items-center gap-1">Designed for Excellence in <span class="text-amber-600">Selangor</span></p>
            </div>
        </div>
    </footer>
